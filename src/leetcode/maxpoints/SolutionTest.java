...
public class SolutionTest
{
	...
	public static void main(String args[])
	{
		...
		Point[] points2 = { new Point(0, 0), new Point(1, 1), new Point(0, 0)};
		System.out.println( sol.maxPoints(points2) );
		
		Point[] points3 = { new Point(0, 0)};
		System.out.println( sol.maxPoints(points3) );
		
		Point[] points4 = { new Point(0, 0), new Point(0, 1)};
		System.out.println( sol.maxPoints(points4) );
		...
		System.out.println( sol.maxPoints(points5) );
	}
}